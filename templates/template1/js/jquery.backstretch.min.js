/*! Backstretch - v2.1.18 - 2019-09-18\n* Copyright (c) 2019 Scott Robbin;* Fork of improvements - by Daniel Cohen Gindi (danielgindi@gmail.com) Licensed MIT */ !(function(
        ...
        g = (function() {
            var c = function(a) {
                    for (var b = 1; b < a.length; b++) {
                        for (
                            var c = a[b], d = b; a[d - 1] && parseInt(a[d - 1].width, 10) > parseInt(c.width, 10);
                ...
                d = function(a, c, d) {
                    for (
                        ...
                        ((f = d[k]),
                            ...
                            ((j = k),
                                (e = a),
                                "auto" === f.pixelRatio && (a *= g), !(f.width >= e))); k++
                    );
        ...
        n = function(c, d, e) {
            ...
            if (
                ((this.$wrap = l.length ?
                    ...
                    .appendTo(this.$container)), !this.options.bypassCss)
            ) {
                if (!this.isBody) {
                ...
                return (
                    ...
                    e.$item.bind(l ? "canplay" : "load", function(f) {
                        ...
                        var q = function(a) {
                            ...
                            u = function() {
                                i && (i.stop(), i.destroy()),
                                    g.remove(), !e.paused && e.images.length > 1 && e.cycle(),
                                    e.options.bypassCss ||
                                    e.isBody ||
    ...
    (p.prototype.init = function(d) {
        ...
        if (
            ...
            for (
                var k = d.url instanceof Array ? d.url : [d.url], l = 0; l < k.length; l++
            ) {
                var m = k[l];
